    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <h3 class="fancy-title"><span><center>Login</center></span></h3>
          <!-- Form -->
					<form class="form-horizontal" role="form">
						<div class="form-group">
							<div class="col-sm-12">
								Email<input type="email" class="form-control" id="inputEmail" placeholder="Email">
							</div>
							<div class="col-sm-12">
								Password<input type="password" class="form-control" id="inputEmail3" placeholder="Password">
							</div>
							<div class="col-sm-4 col-sm-offset-4">
								<a type="submit" class="btn btn-primary center-block">Login</a>
							</div>
						</div>
					</form>
          <!-- /Form -->
