<?php include 'header.php'; ?>
  <!-- Main Wrapper Header -->
  <div class="main-wrapper-header fancy-header dark-header parallax parallax-portfolio" data-stellar-background-ratio="0.4" style="background-position: 50% 75.2px;">
    <div class="bg-overlay bg-overlay-gdark"></div>
    <div class="container">
			<div class="row">
        <div class="col-sm-12 columns">
          <div class="page-title">
            <h2>Pramukh Developers</h2>
          </div>
          <div class="breadcrumbs-wrapper">
						<ol class="breadcrumb">
							<li><a href="/index.php">Home</a></li>
							<li><a href="/clientele.php">Clientele</a></li>
							<li class="active">Pramukh Developers</li>
						</ol> 
          </div>
				</div>
			</div>
							...
							<div class="carousel" data-carousel-autoplay="false" data-carousel-nav="true" data-carousel-pagination="true" data-carousel-single="true" data-carousel-speed="1000" data-carousel-transition="fadeUp">
								<div>
									...
									<div class="overlay-wrapper">
										<img src="img/client/pramukh.jpg" alt="Portfolio 1"/>
...
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
								...
								<div>
									<!-- Overlay Img -->
									<div class="overlay-wrapper">
										<img src="img/client/pramukh1.jpg" alt="Portfolio 2"/>
										<div class="overlay-wrapper-content">
											<div class="overlay-details">
                                        		<a href="img/client/pramukh1.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
								...
								<div>
									<!-- Overlay Img -->
									<div class="overlay-wrapper">
										<img src="img/client/pramukh2.jpg" alt="Portfolio 3"/>
										<div class="overlay-wrapper-content">
											<div class="overlay-details">
                                        		<a href="img/client/pramukh2.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                        	<div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh3.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh3.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh4.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh4.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh5.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh5.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh6.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh6.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh7.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh7.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh8.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh8.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
              ...
              <div>
                  <!-- Overlay Img -->
                  <div class="overlay-wrapper">
                    <img src="img/client/pramukh9.jpg" alt="Portfolio 3"/>
                    <div class="overlay-wrapper-content">
                      <div class="overlay-details">
                                            <a href="img/client/pramukh9.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                          <div class="overlay-bg bg-color-dark"></div>
                    ...
                    <div class="col-md-4 col-sm-6">	
                    	<h4 class="fancy-title"><span>Pramukh Developers</span></h4>	
...
<!--
                        ...
                        <ul class="divider-list list-unstyled">
                        	<li><strong>Customer:</strong> <a href="http://themeforest.net/user/4GraFx/portfolio">Themeforest</a></li>
                            <li><strong>Date:</strong> 05.04.2014 - 01.09.2014</li>
                        	<li><strong>Categories:</strong> <a href="#">Web Design</a>, <a href="#">UI Design</a></li>
                        	<li><strong>Skills:</strong> <a href="#">HTML5</a>, <a href="#">CSS3</a>, <a href="#">jQuery</a>, <a href="#">PHP</a></li>
                    	</ul>
                        <div class="white-space space-big"></div> 
-->
                	</div>
...
<!--
				<div class="row">
					<div class="col-md-12">
						<h4 class="fancy-title text-center"><span>Related Projects</span></h4>
						<div class="white-space space-xsmall"></div>
					</div>
				</div>
				...
				<div class="carousel-box" >
					<div class="carousel" data-carousel-autoplay="false" data-carousel-items="3" data-carousel-nav="true" data-carousel-pagination="false"  data-carousel-speed="1000">
						<div class="carousel-item animation fadeInLeft">
							<div class="overlay-wrapper">
								<img src="img/why_astorion/bus.jpg" alt="Portfolio 1">
								<div class="overlay-wrapper-content">
									<div class="overlay-details">
                                    	<a href="img/why_astorion/bus.jpg" data-lightbox="image"><span class="livicon" data-n="plus"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>
<!--                                        <a href="#"><span class="livicon" data-n="more"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>                                    	
                                    </div>
                               		<div class="overlay-bg"></div>
                            	</div>
							</div>
                            <div class="portfolio-item-content">
                            	<h3 class="portfolio-item-title"><a href="/mobile.php">BUS BRANDING</a></h3>
                                <p class="text-justify">A renowned Bank wanted to target the Corporate in Dadra & Nagar Haveli, Daman & Vapi.</p>
                            </div>	                                                
						</div>
                        
						<div class="carousel-item animation fadeInLeft delay1">
							<div class="overlay-wrapper">
								<img src="img/why_astorion/mobile.jpg" alt="Portfolio 2">
								<div class="overlay-wrapper-content">
									<div class="overlay-details">
                                    	<a href="img/why_astorion/mobile.jpg" data-lightbox="image"><span class="livicon" data-n="plus"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>
<!--                                        <a href="#"><span class="livicon" data-n="more"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>                                    	
                                    </div>
                               		<div class="overlay-bg"></div>
                            	</div>
                            ...
                            <div class="portfolio-item-content">
                                ...
                                <p class="text-justify">Hoardings have the restriction of location as they are fixed. Customer had to take 4 hoardings to cater to four different site.</p>
                            </div>	                                                
						</div>
                        
						<div class="carousel-item animation fadeInLeft delay2">
							<div class="overlay-wrapper">
								<img src="img/why_astorion/mini.jpg" alt="Portfolio 3">
								<div class="overlay-wrapper-content">
									<div class="overlay-details">
                                    	<a href="img/why_astorion/mini.jpg" data-lightbox="image"><span class="livicon" data-n="plus"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>
<!--                                        <a href="#"><span class="livicon" data-n="more"  data-color="#ffffff" data-hovercolor="#ffffff" data-op="1" data-onparent="true"></span></a>                                    	--
                                    </div>
                               		<div class="overlay-bg"></div>
                            	</div>
                            ...
                            <div class="portfolio-item-content">
                            	<h3 class="portfolio-item-title"><a href="/mini.php">MINI HOARDINGS</a></h3>
                                <p class="text-justify">At Borivali station, one will find either boards or hoardings. We developed a back-lit Mini Hoarding, which was distinctively visible on the crowded station.</p>
                            </div>	                                                
						</div>
