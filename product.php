        ...
        <div class="col-sm-12 columns">
          ...
          <div class="breadcrumbs-wrapper">
						<ol class="breadcrumb">
							...
							<li class="active">Product Designing</li>
						</ol> 
          </div>
				</div>
			</div>
							...
							<div class="carousel" data-carousel-autoplay="false" data-carousel-nav="true" data-carousel-pagination="true" data-carousel-single="true" data-carousel-speed="1000" data-carousel-transition="fadeUp">
								<div>
									...
									<div class="overlay-wrapper">
										<img src="img/media/product.jpg" alt="Portfolio 1"/>
										<div class="overlay-wrapper-content">
											<div class="overlay-details">
                                        		<a href="img/media/product.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
...
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
								...
								<div>
									<!-- Overlay Img -->
									<div class="overlay-wrapper">
										<img src="img/media/product1.jpg" alt="Portfolio 2"/>
										<div class="overlay-wrapper-content">
											<div class="overlay-details">
                                        		<a href="img/media/product1.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
								...
								<div>
									<!-- Overlay Img -->
									<div class="overlay-wrapper">
										<img src="img/media/product2.jpg" alt="Portfolio 3"/>
										<div class="overlay-wrapper-content">
											<div class="overlay-details">
                                        		<a href="img/media/product2.jpg" data-lightbox="image"><span class="fa fa-plus"></span></a>
<!--                                                <a href="http://themeforest.net/user/4GraFx/portfolio"><span class="fa fa-share"></span></a>
-->                                                <a href="#"><span class="fa fa-heart-o"></span></a>
                                            </div>
                                        	<div class="overlay-bg bg-color-dark"></div>
                    ...
                    <div class="col-md-4 col-sm-6">	
                    	<h4 class="fancy-title"><span>Product Designing</span></h4>	
