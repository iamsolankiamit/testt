     ...
     <div class="col-sm-12 columns">
      ...
      <div class="breadcrumbs-wrapper">
       <ol class="breadcrumb">
        ...
        <li class="active">Why Astorion</li>
      </ol>
    </div>
  </div>
</div>
            ...
            <div class="container">
              ...
              <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                      <h3 class="fancy-title text-center animation fadeInDown animation-active"><span>Why Us.</span></h3>
                        <p class="lead text-center"><em>The success of our Innovations stems from our ability to provide comprehensive and customized OOH solutions to clientele giving them flexibility to reach target market segments.</em></p>
...
<!-- Parallax Container -->
<!--
            <div class="parallax parallax-background10" data-stellar-background-ratio="0.4" style="background-position: 50% 86.4px;">
              ...
              <div class="container">
                <div class="row">
                      <div class="col-md-6">
                        ...
                        <p class="lead text-center color-white">Do you have a project? We are here to help!</p>
                      </div>
                      <div class="col-md-6">
